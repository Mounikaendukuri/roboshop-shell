...
for name in ${instances[@]}; do
    ...
    instance_id=$(aws ec2 run-instances --image-id ami-041e2ea9402c46c32 --instance-type $instance_type --security-group-ids sg-0510d95861e69f660 --subnet-id subnet-09863c54177764565 --query 'Instances[0].InstanceId' --output text)
